...
from laakhay.data.clients.ohlcv_feed import OHLCVFeed
from laakhay.data.core import MarketType, Timeframe
from laakhay.data.providers.binance import BinanceProvider, BinanceRESTProvider


def parse_args() -> argparse.Namespace:
    p = argparse.ArgumentParser(description="Quickstart for OHLCVFeed streaming + cache")
...
async def main() -> None:
    ...
    feed = OHLCVFeed(ws_provider=ws, rest_provider=rest, throttle_ms=500, max_bar_history=5)
