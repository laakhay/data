"""Unified Kraken provider that wraps REST and WebSocket implementations."""
...
class KrakenProvider(BaseProvider):
    """High-level Kraken provider exposing REST and streaming helpers."""
    ...
    def __init__(
        ...
        *,
        ...
        rest_provider: KrakenRESTProvider | None = None,
        ws_provider: KrakenWSProvider | None = None,
    ) -> None:
        super().__init__(name="kraken")
        self.market_type = market_type
        self._rest = rest_provider or KrakenRESTProvider(
            market_type=market_type, api_key=api_key, api_secret=api_secret
        )
        self._ws = ws_provider or KrakenWSProvider(market_type=market_type)
    ...
    async def describe_capabilities(
        ...
        *,
        ...
        """Describe capabilities for Kraken.
