...
from laakhay.data.connectors.kraken.rest.provider import KrakenRESTConnector
from laakhay.data.connectors.kraken.ws.provider import KrakenWSConnector
...
class KrakenProvider:
    """Unified Kraken provider combining REST and WebSocket connectors.
    ...
    def __init__(
        ...
        *,
        ...
        rest_connector: KrakenRESTConnector | None = None,
        ws_connector: KrakenWSConnector | None = None,
    ) -> None:
        """Initialize unified Kraken provider.
        ...
        self._ws = ws_connector or KrakenWSConnector(market_type=market_type)
    ...
    async def iterate_ohlcv(
        ...
        *,
        ...
        """Iterate over OHLCV bars chunk-by-chunk."""
    ...
    async def stream_order_book(
        self,
        symbol: str,
        update_speed: str = "100ms",  # noqa: ARG002
    ...
    async def stream_mark_price(
        self,
        symbols: list[str],
        update_speed: str = "1s",  # noqa: ARG002
    ...
    async def __aenter__(self) -> KrakenProvider:
