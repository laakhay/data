"""Binance WebSocket connector for direct use by researchers.

This connector provides direct access to Binance WebSocket streams without
...
class BinanceWSConnector(WSProvider):
    """Binance WebSocket connector for direct research use.

    This connector can be used directly without going through DataRouter.
    It provides full access to Binance WebSocket streams with automatic
    ...
    async def stream(
        ...
        *,
        ...
        """Stream data from a Binance WebSocket endpoint.
