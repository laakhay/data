"""Binance mark price WebSocket endpoint specification and adapter.
...
class Adapter(MessageAdapter):
    """Adapter for parsing Binance mark price WebSocket messages."""
    ...
    def parse(self, payload: Any) -> list[MarkPrice]:
        """Parse Binance mark price WebSocket message.
