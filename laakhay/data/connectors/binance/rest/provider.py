"""Binance REST connector for direct use by researchers.

This connector provides direct access to Binance REST endpoints without
...
class BinanceRESTConnector(RESTProvider):
    """Binance REST connector for direct research use.
    ...
    def __init__(
        ...
        *,
        ...
        """Initialize Binance REST connector.
    ...
    async def fetch(self, endpoint_id: str, params: dict[str, Any]) -> Any:
        """Fetch data from a Binance REST endpoint.
