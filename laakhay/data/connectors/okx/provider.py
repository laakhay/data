"""Unified OKX connector provider.
...
class OKXProvider:
    """Unified OKX provider combining REST and WebSocket connectors.
    ...
    def __init__(
        ...
        *,
        ...
        rest_connector: OKXRESTConnector | None = None,
        ws_connector: OKXWSConnector | None = None,
    ) -> None:
        """Initialize unified OKX provider.
        ...
        self._ws = ws_connector or OKXWSConnector(market_type=market_type)
    ...
    async def __aenter__(self) -> OKXProvider:
