"""MEXC WebSocket connector for direct use by researchers.

This connector provides direct access to MEXC WebSocket streams without
...
class MEXCWSConnector(WSProvider):
    ...
    async def stream(
        ...
        *,
        ...
        """Stream data from a MEXC WebSocket endpoint.
