"""Unified MEXC connector provider.
...
from laakhay.data.connectors.mexc.config import INTERVAL_MAP
...
class MEXCProvider:
    """Unified MEXC provider combining REST and WebSocket connectors.
    ...
    def __init__(
        ...
        *,
        ...
        rest_connector: MEXCRESTConnector | None = None,
        ws_connector: MEXCWSConnector | None = None,
    ) -> None:
        """Initialize unified MEXC provider.
        ...
        self._ws = ws_connector or MEXCWSConnector(market_type=market_type)
