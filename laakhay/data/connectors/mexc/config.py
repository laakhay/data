"""Shared MEXC provider constants.
...
BASE_URLS = {
    MarketType.SPOT: "https://api.mexc.com",
    MarketType.FUTURES: "https://contract.mexc.com",
}
...
WS_SINGLE_URLS = {
    MarketType.SPOT: "wss://wbs.mexc.com/ws",
    MarketType.FUTURES: "wss://contract.mexc.com/ws",
}

WS_COMBINED_URLS = {
    MarketType.SPOT: "wss://wbs.mexc.com/stream",
    MarketType.FUTURES: "wss://contract.mexc.com/stream",
}

# MEXC interval mapping (similar to Binance)
INTERVAL_MAP = {
    Timeframe.M1: "1m",
    Timeframe.M3: "3m",
    Timeframe.M5: "5m",
